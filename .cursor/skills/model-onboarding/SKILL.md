...
description: Onboards an autonomous-driving perception model from reference repo and paper into pure PyTorch implementation, intermediate tensor tests, study documentation, and progress logging. Use when adding a new model or planning a model port.
---

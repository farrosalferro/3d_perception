...
from .utils import SinePositionalEncoding2D, inverse_sigmoid, pos2posemb3d
...
class PETRHeadLite(nn.Module):
    ...
    def forward(self, mlvl_feats: list[torch.Tensor], img_metas: list[dict]) -> dict[str, torch.Tensor]:
        ...
        outs_dec = outs_dec.permute(0, 2, 1, 3)  # [L, B, Q, C]
        ...
        for lvl in range(outs_dec.shape[0]):
            ...
            tmp[..., 4:5] = tmp[..., 4:5] * (self.cfg.pc_range[5] - self.cfg.pc_range[2]) + self.cfg.pc_range[2]

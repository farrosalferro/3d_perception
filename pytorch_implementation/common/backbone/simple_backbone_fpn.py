"""Shared lightweight backbone + FPN components."""
...
class BackboneNeckConfigProtocol(Protocol):
...
class BackboneNeck(nn.Module):
    """Backbone+neck wrapper that mirrors image feature APIs used by models."""

    def __init__(self, cfg: BackboneNeckConfigProtocol) -> None:
        super().__init__()
        self.cfg = cfg

...
| 2026-03-09 | prediction/beverse | `HEAD` (detached) | completed (prediction forward + intermediate tensor checks + horizon/metric checks) | `pytorch_implementation/prediction/beverse/` | `tests/prediction/beverse.py` | `study/markdown/prediction/beverse_paper_to_code.md` | `study/notebook/prediction/beverse_paper_to_code.ipynb` | https://arxiv.org/abs/2205.09743 | Pure-PyTorch BEVerse-style prediction path onboarded with multimodal trajectory decoding, horizon/time-axis integrity tests, trajectory consistency checks, and ADE/FDE metric smoke validation. |
